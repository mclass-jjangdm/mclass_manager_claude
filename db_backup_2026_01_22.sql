...
(153,'Can add 교재 목차',39,'add_bookcontent'),
(154,'Can change 교재 목차',39,'change_bookcontent'),
(155,'Can delete 교재 목차',39,'delete_bookcontent'),
(156,'Can view 교재 목차',39,'view_bookcontent'),
(157,'Can add 학생 진도 기록',40,'add_studentbookprogress'),
(158,'Can change 학생 진도 기록',40,'change_studentbookprogress'),
(159,'Can delete 학생 진도 기록',40,'delete_studentbookprogress'),
(160,'Can view 학생 진도 기록',40,'view_studentbookprogress'),
(161,'Can add 메시지',41,'add_message'),
(162,'Can change 메시지',41,'change_message'),
(163,'Can delete 메시지',41,'delete_message'),
(164,'Can view 메시지',41,'view_message'),
(165,'Can add 메시지 읽음 상태',42,'add_messagereadstatus'),
(166,'Can change 메시지 읽음 상태',42,'change_messagereadstatus'),
(167,'Can delete 메시지 읽음 상태',42,'delete_messagereadstatus'),
(168,'Can view 메시지 읽음 상태',42,'view_messagereadstatus');
...
(1,'pbkdf2_sha256$1000000$0IiEFr9KIgbxjDwlzxzrTr$0cYbR9GZQiVo54uzk3Wsr6gNEj9hiIZ6hHoXOQFl8w8=','2026-01-22 01:56:22.408052',1,'admin','','','jjangdm@mclass.co.kr',1,1,'2024-10-13 00:29:21.374000'),
(2,'pbkdf2_sha256$1000000$SdGs3jGf7f1OyS6qZKkvsb$xd7JJj+OgtLB+KmPuYJ1sby72/l0wS5u2xq6gsbhpRM=','2026-01-22 01:36:05.110618',0,'younwoo','강연우','','',0,1,'2026-01-19 01:57:05.795402'),
(3,'pbkdf2_sha256$1000000$gIawkg8FVAYPCFUV3xF9fP$8u2DenrRWEEVbwICtwnrGQpqvmry69BDraWn8j4QHqk=','2026-01-22 00:57:52.102356',0,'kang','강재윤','','algud050@gmail.com',0,1,'2026-01-19 02:29:47.487431');
...
(5,'수학의 바이블 유형 on 라이트 공통수학. 1','9791138932981','이투스에듀,이투스북 [편]','이투스에듀 : 이투스북',18000,13500,15000,1,'','2026-01-02 00:00:00.000000',1,184,'8932981'),
(6,'(新) 수학의 바이블 : 개념 : 중학. 3-2','9791164425068','저자: 강해기,권영기,김보현,김숙영,노솔,박성복,신지영,이서진,임상현,장이지,정란,천태선,이투스 중학 수학 연구회','이투스에듀 : 이투스북',15000,11250,12000,1,'','2026-01-02 00:00:00.000000',1,189,'4425068'),
...
(21,'짱 중요한 유형 수학1 (2025년)','9791191229936','이창주','아름다운샘',16000,12000,13000,2,'','2026-12-26 00:00:00.000000',1,30,'1229936'),
...
--
-- Table structure for table `bookstore_bookcontent`
--

DROP TABLE IF EXISTS `bookstore_bookcontent`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `bookstore_bookcontent` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `chapter_num` int unsigned NOT NULL,
  `chapter_title` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `section_num` int unsigned NOT NULL,
  `section_title` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `subsection_num` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `subsection_title` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `page` int unsigned NOT NULL,
  `book_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `bookstore_bookcontent_book_id_page_3406238c_uniq` (`book_id`,`page`),
  CONSTRAINT `bookstore_bookcontent_book_id_d9f4db1d_fk_bookstore_book_id` FOREIGN KEY (`book_id`) REFERENCES `bookstore_book` (`id`),
  CONSTRAINT `bookstore_bookcontent_chk_1` CHECK ((`chapter_num` >= 0)),
  CONSTRAINT `bookstore_bookcontent_chk_2` CHECK ((`section_num` >= 0)),
  CONSTRAINT `bookstore_bookcontent_chk_3` CHECK ((`page` >= 0))
) ENGINE=InnoDB AUTO_INCREMENT=207 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `bookstore_bookcontent`
--

LOCK TABLES `bookstore_bookcontent` WRITE;
/*!40000 ALTER TABLE `bookstore_bookcontent` DISABLE KEYS */;
set autocommit=0;
INSERT INTO `bookstore_bookcontent` VALUES
(1,1,'소인수분해',1,'소인수분해','1','소수와 합성수',8,15),
(2,1,'소인수분해',1,'소인수분해','1','소수와 합성수',9,15),
(3,1,'소인수분해',1,'소인수분해','2','거듭제곱',10,15),
(4,1,'소인수분해',1,'소인수분해','2','거듭제곱',11,15),
(5,1,'소인수분해',1,'소인수분해','90','배운대로 학습하기',12,15),
(6,1,'소인수분해',1,'소인수분해','3','소인수분해',13,15),
(7,1,'소인수분해',1,'소인수분해','3','소인수분해',14,15),
(8,1,'소인수분해',1,'소인수분해','4','소인수분해를 이용하여 약수 구하기',15,15),
(9,1,'소인수분해',1,'소인수분해','4','소인수분해를 이용하여 약수 구하기',16,15),
(10,1,'소인수분해',1,'소인수분해','4','소인수분해를 이용하여 약수 구하기',17,15),
(11,1,'소인수분해',1,'소인수분해','90','배운대로 학습하기',18,15),
(12,1,'소인수분해',1,'소인수분해','90','배운대로 학습하기',19,15),
(13,1,'소인수분해',1,'소인수분해','93','서술형 훈련하기',20,15),
(14,1,'소인수분해',1,'소인수분해','93','서술형 훈련하기',21,15),
(15,1,'소인수분해',1,'소인수분해','91','중단원 마무리하기',22,15),
(16,1,'소인수분해',1,'소인수분해','91','중단원 마무리하기',23,15),
(17,1,'소인수분해',1,'소인수분해','91','중단원 마무리하기',24,15),
(18,1,'소인수분해',2,'최대공약수와 최소공배수','91','중단원 마무리하기',25,15),
(19,1,'소인수분해',2,'최대공약수와 최소공배수','1','최대공약수',26,15),
(20,1,'소인수분해',2,'최대공약수와 최소공배수','1','최대공약수',27,15),
(21,1,'소인수분해',2,'최대공약수와 최소공배수','2','최대공약수 구하기',28,15),
(22,1,'소인수분해',2,'최대공약수와 최소공배수','2','최대공약수 구하기',29,15),
(23,1,'소인수분해',2,'최대공약수와 최소공배수','2','최대공약수 구하기',30,15),
(24,1,'소인수분해',2,'최대공약수와 최소공배수','90','배운대로 학습하기',31,15),
(25,1,'소인수분해',2,'최대공약수와 최소공배수','3','최소공배수',32,15),
(26,1,'소인수분해',2,'최대공약수와 최소공배수','3','최소공배수',33,15),
(27,1,'소인수분해',2,'최대공약수와 최소공배수','4','최소공배수 구하기',34,15),
(28,1,'소인수분해',2,'최대공약수와 최소공배수','4','최소공배수 구하기',35,15),
(29,1,'소인수분해',2,'최대공약수와 최소공배수','4','최소공배수 구하기',36,15),
(30,1,'소인수분해',2,'최대공약수와 최소공배수','4','최소공배수 구하기',37,15),
(31,1,'소인수분해',2,'최대공약수와 최소공배수','5','최대공약수와 최소공배수의 관계',38,15),
(32,1,'소인수분해',2,'최대공약수와 최소공배수','5','최대공약수와 최소공배수의 관계',39,15),
(33,1,'소인수분해',2,'최대공약수와 최소공배수','90','배운대로 학습하기',40,15),
(34,1,'소인수분해',2,'최대공약수와 최소공배수','90','배운대로 학습하기',41,15),
(35,1,'소인수분해',2,'최대공약수와 최소공배수','93','서술형 훈련하기',42,15),
(36,1,'소인수분해',2,'최대공약수와 최소공배수','93','서술형 훈련하기',43,15),
(37,1,'소인수분해',2,'최대공약수와 최소공배수','91','중단원 마무리하기',44,15),
(38,1,'소인수분해',2,'최대공약수와 최소공배수','91','중단원 마무리하기',45,15),
(39,1,'소인수분해',2,'최대공약수와 최소공배수','91','중단원 마무리하기',46,15),
(40,1,'소인수분해',2,'최대공약수와 최소공배수','91','중단원 마무리하기',47,15),
(41,2,'정수와 유리수',3,'정수와 유리수','1','양수와 음수, 정수',50,15),
(42,2,'정수와 유리수',3,'정수와 유리수','1','양수와 음수, 정수',51,15),
(43,2,'정수와 유리수',3,'정수와 유리수','2','유리수',52,15),
(44,2,'정수와 유리수',3,'정수와 유리수','2','유리수',53,15),
(45,2,'정수와 유리수',3,'정수와 유리수','3','수직선',54,15),
(46,2,'정수와 유리수',3,'정수와 유리수','3','수직선',55,15),
(47,2,'정수와 유리수',3,'정수와 유리수','3','수직선',56,15),
(48,2,'정수와 유리수',3,'정수와 유리수','90','배운대로 학습하기',57,15),
(49,2,'정수와 유리수',3,'정수와 유리수','90','배운대로 학습하기',58,15),
(50,2,'정수와 유리수',3,'정수와 유리수','4','절댓값',59,15),
(51,2,'정수와 유리수',3,'정수와 유리수','4','절댓값',60,15),
(52,2,'정수와 유리수',3,'정수와 유리수','4','절댓값',61,15),
(53,2,'정수와 유리수',3,'정수와 유리수','5','수의 대소 관계',62,15),
(54,2,'정수와 유리수',3,'정수와 유리수','5','수의 대소 관계',63,15),
(55,2,'정수와 유리수',3,'정수와 유리수','90','배운대로 학습하기',64,15),
(56,2,'정수와 유리수',3,'정수와 유리수','90','배운대로 학습하기',65,15),
(57,2,'정수와 유리수',3,'정수와 유리수','93','서술형 훈련하기',66,15),
(58,2,'정수와 유리수',3,'정수와 유리수','93','서술형 훈련하기',67,15),
(59,2,'정수와 유리수',3,'정수와 유리수','91','중단원 마무리하기',68,15),
(60,2,'정수와 유리수',3,'정수와 유리수','91','중단원 마무리하기',69,15),
(61,2,'정수와 유리수',3,'정수와 유리수','91','중단원 마무리하기',70,15),
(62,2,'정수와 유리수',4,'정수와 유리수의 덧셈과 뺄셈','1','유리수의 덧셈',72,15),
(63,2,'정수와 유리수',4,'정수와 유리수의 덧셈과 뺄셈','1','유리수의 덧셈',73,15),
(64,2,'정수와 유리수',4,'정수와 유리수의 덧셈과 뺄셈','2','덧셈의 계산 법칙',74,15),
(65,2,'정수와 유리수',4,'정수와 유리수의 덧셈과 뺄셈','2','덧셈의 계산 법칙',75,15),
(66,2,'정수와 유리수',4,'정수와 유리수의 덧셈과 뺄셈','90','배운대로 학습하기',76,15),
(67,2,'정수와 유리수',4,'정수와 유리수의 덧셈과 뺄셈','3','유리수의 뺄셈',77,15),
(68,2,'정수와 유리수',4,'정수와 유리수의 덧셈과 뺄셈','3','유리수의 뺄셈',78,15),
(69,2,'정수와 유리수',4,'정수와 유리수의 덧셈과 뺄셈','4','덧셈과 뺄셈의 혼합 계산',79,15),
(70,2,'정수와 유리수',4,'정수와 유리수의 덧셈과 뺄셈','4','덧셈과 뺄셈의 혼합 계산',80,15),
(71,2,'정수와 유리수',4,'정수와 유리수의 덧셈과 뺄셈','4','덧셈과 뺄셈의 혼합 계산',81,15),
(72,2,'정수와 유리수',4,'정수와 유리수의 덧셈과 뺄셈','90','배운대로 학습하기',82,15),
(73,2,'정수와 유리수',4,'정수와 유리수의 덧셈과 뺄셈','90','배운대로 학습하기',83,15),
(74,2,'정수와 유리수',4,'정수와 유리수의 덧셈과 뺄셈','93','서술형 훈련하기',84,15),
(75,2,'정수와 유리수',4,'정수와 유리수의 덧셈과 뺄셈','93','서술형 훈련하기',85,15),
(76,2,'정수와 유리수',4,'정수와 유리수의 덧셈과 뺄셈','91','중단원 마무리하기',86,15),
(77,2,'정수와 유리수',4,'정수와 유리수의 덧셈과 뺄셈','91','중단원 마무리하기',87,15),
(78,2,'정수와 유리수',4,'정수와 유리수의 덧셈과 뺄셈','91','중단원 마무리하기',88,15),
(79,2,'정수와 유리수',5,'정수와 유리수의 곱셈과 나눗셈','1','유리수의 곱셈',90,15),
(80,2,'정수와 유리수',5,'정수와 유리수의 곱셈과 나눗셈','1','유리수의 곱셈',91,15),
(81,2,'정수와 유리수',5,'정수와 유리수의 곱셈과 나눗셈','2','곱셈의 계산 법칙',92,15),
(82,2,'정수와 유리수',5,'정수와 유리수의 곱셈과 나눗셈','2','곱셈의 계산 법칙',93,15),
(83,2,'정수와 유리수',5,'정수와 유리수의 곱셈과 나눗셈','3','세 개 이상의 유리수의 곱셈',94,15),
(84,2,'정수와 유리수',5,'정수와 유리수의 곱셈과 나눗셈','3','세 개 이상의 유리수의 곱셈',95,15),
(85,2,'정수와 유리수',5,'정수와 유리수의 곱셈과 나눗셈','4','분배법칙',96,15),
(86,2,'정수와 유리수',5,'정수와 유리수의 곱셈과 나눗셈','4','분배법칙',97,15),
(87,2,'정수와 유리수',5,'정수와 유리수의 곱셈과 나눗셈','90','배운대로 학습하기',98,15),
(88,2,'정수와 유리수',5,'정수와 유리수의 곱셈과 나눗셈','90','배운대로 학습하기',99,15),
(89,2,'정수와 유리수',5,'정수와 유리수의 곱셈과 나눗셈','5','유리수의 나눗셈',100,15),
(90,2,'정수와 유리수',5,'정수와 유리수의 곱셈과 나눗셈','5','유리수의 나눗셈',101,15),
(91,2,'정수와 유리수',5,'정수와 유리수의 곱셈과 나눗셈','6','정수와 유리수의 혼합 계산',102,15),
(92,2,'정수와 유리수',5,'정수와 유리수의 곱셈과 나눗셈','6','정수와 유리수의 혼합 계산',103,15),
(93,2,'정수와 유리수',5,'정수와 유리수의 곱셈과 나눗셈','6','정수와 유리수의 혼합 계산',104,15),
(94,2,'정수와 유리수',5,'정수와 유리수의 곱셈과 나눗셈','6','정수와 유리수의 혼합 계산',105,15),
(95,2,'정수와 유리수',5,'정수와 유리수의 곱셈과 나눗셈','90','배운대로 학습하기',106,15),
(96,2,'정수와 유리수',5,'정수와 유리수의 곱셈과 나눗셈','90','배운대로 학습하기',107,15),
(97,2,'정수와 유리수',5,'정수와 유리수의 곱셈과 나눗셈','93','서술형 훈련하기',108,15),
(98,2,'정수와 유리수',5,'정수와 유리수의 곱셈과 나눗셈','93','서술형 훈련하기',109,15),
(99,2,'정수와 유리수',5,'정수와 유리수의 곱셈과 나눗셈','91','중단원 마무리하기',110,15),
(100,2,'정수와 유리수',5,'정수와 유리수의 곱셈과 나눗셈','91','중단원 마무리하기',111,15),
(101,2,'정수와 유리수',5,'정수와 유리수의 곱셈과 나눗셈','91','중단원 마무리하기',112,15),
(102,2,'정수와 유리수',5,'정수와 유리수의 곱셈과 나눗셈','91','중단원 마무리하기',113,15),
(103,3,'문자와 식',6,'문자와 식','1','곱셈 기호와 나눗셈 기호의 생략',116,15),
(104,3,'문자와 식',6,'문자와 식','1','곱셈 기호와 나눗셈 기호의 생략',117,15),
(105,3,'문자와 식',6,'문자와 식','2','문자의 사용',118,15),
(106,3,'문자와 식',6,'문자와 식','2','문자의 사용',119,15),
(107,3,'문자와 식',6,'문자와 식','3','식의 값',120,15),
(108,3,'문자와 식',6,'문자와 식','3','식의 값',121,15),
(109,3,'문자와 식',6,'문자와 식','90','배운대로 학습하기',122,15),
(110,3,'문자와 식',6,'문자와 식','4','다항식과 일차식',123,15),
(111,3,'문자와 식',6,'문자와 식','4','다항식과 일차식',124,15),
(112,3,'문자와 식',6,'문자와 식','5','일차식과 수의 곱셈, 나눗셈',125,15),
(113,3,'문자와 식',6,'문자와 식','5','일차식과 수의 곱셈, 나눗셈',126,15),
(114,3,'문자와 식',6,'문자와 식','90','배운대로 학습하기',127,15),
(115,3,'문자와 식',6,'문자와 식','6','동류항',128,15),
(116,3,'문자와 식',6,'문자와 식','6','동류항',129,15),
(117,3,'문자와 식',6,'문자와 식','7','일차식의 덧셈과 뺄셈',130,15),
(118,3,'문자와 식',6,'문자와 식','7','일차식의 덧셈과 뺄셈',131,15),
(119,3,'문자와 식',6,'문자와 식','7','일차식의 덧셈과 뺄셈',132,15),
(120,3,'문자와 식',6,'문자와 식','7','일차식의 덧셈과 뺄셈',133,15),
(121,3,'문자와 식',6,'문자와 식','90','배운대로 학습하기',134,15),
(122,3,'문자와 식',6,'문자와 식','90','배운대로 학습하기',135,15),
(123,3,'문자와 식',6,'문자와 식','93','서술형 훈련하기',136,15),
(124,3,'문자와 식',6,'문자와 식','93','서술형 훈련하기',137,15),
(125,3,'문자와 식',6,'문자와 식','91','중단원 마무리하기',138,15),
(126,3,'문자와 식',6,'문자와 식','91','중단원 마무리하기',139,15),
(127,3,'문자와 식',6,'문자와 식','91','중단원 마무리하기',140,15),
(128,3,'문자와 식',7,'일차방정식의 풀이','1','방정식과 항등식',142,15),
(129,3,'문자와 식',7,'일차방정식의 풀이','1','방정식과 항등식',143,15),
(130,3,'문자와 식',7,'일차방정식의 풀이','1','방정식과 항등식',144,15),
(131,3,'문자와 식',7,'일차방정식의 풀이','2','등식의 성질',145,15),
(132,3,'문자와 식',7,'일차방정식의 풀이','2','등식의 성질',146,15),
(133,3,'문자와 식',7,'일차방정식의 풀이','90','배운대로 학습하기',147,15),
(134,3,'문자와 식',7,'일차방정식의 풀이','3','일차방정식',148,15),
(135,3,'문자와 식',7,'일차방정식의 풀이','3','일차방정식',149,15),
(136,3,'문자와 식',7,'일차방정식의 풀이','4','일차방정식의 풀이',150,15),
(137,3,'문자와 식',7,'일차방정식의 풀이','4','일차방정식의 풀이',151,15),
(138,3,'문자와 식',7,'일차방정식의 풀이','5','복잡한 일차방정식의 풀이',152,15),
(139,3,'문자와 식',7,'일차방정식의 풀이','5','복잡한 일차방정식의 풀이',153,15),
(140,3,'문자와 식',7,'일차방정식의 풀이','5','복잡한 일차방정식의 풀이',154,15),
(141,3,'문자와 식',7,'일차방정식의 풀이','5','복잡한 일차방정식의 풀이',155,15),
(142,3,'문자와 식',7,'일차방정식의 풀이','90','배운대로 학습하기',156,15),
(143,3,'문자와 식',7,'일차방정식의 풀이','90','배운대로 학습하기',157,15),
(144,3,'문자와 식',7,'일차방정식의 풀이','93','서술형 훈련하기',158,15),
(145,3,'문자와 식',7,'일차방정식의 풀이','93','서술형 훈련하기',159,15),
(146,3,'문자와 식',7,'일차방정식의 풀이','91','중단원 마무리하기',160,15),
(147,3,'문자와 식',7,'일차방정식의 풀이','91','중단원 마무리하기',161,15),
(148,3,'문자와 식',7,'일차방정식의 풀이','91','중단원 마무리하기',162,15),
(149,3,'문자와 식',8,'일차방정식의 활용','1','일차방정식의 활용(1)',164,15),
(150,3,'문자와 식',8,'일차방정식의 활용','1','일차방정식의 활용(1)',165,15),
(151,3,'문자와 식',8,'일차방정식의 활용','1','일차방정식의 활용(1)',166,15),
(152,3,'문자와 식',8,'일차방정식의 활용','1','일차방정식의 활용(1)',167,15),
(153,3,'문자와 식',8,'일차방정식의 활용','1','일차방정식의 활용(1)',168,15),
(154,3,'문자와 식',8,'일차방정식의 활용','90','배운대로 학습하기',169,15),
(155,3,'문자와 식',8,'일차방정식의 활용','2','일차방정식의 활용(2)',170,15),
(156,3,'문자와 식',8,'일차방정식의 활용','2','일차방정식의 활용(2)',171,15),
(157,3,'문자와 식',8,'일차방정식의 활용','2','일차방정식의 활용(2)',172,15),
(158,3,'문자와 식',8,'일차방정식의 활용','3','일차방정식의 활용(3)',173,15),
(159,3,'문자와 식',8,'일차방정식의 활용','3','일차방정식의 활용(3)',174,15),
(160,3,'문자와 식',8,'일차방정식의 활용','90','배운대로 학습하기',175,15),
(161,3,'문자와 식',8,'일차방정식의 활용','93','서술형 훈련하기',176,15),
(162,3,'문자와 식',8,'일차방정식의 활용','93','서술형 훈련하기',177,15),
(163,3,'문자와 식',8,'일차방정식의 활용','91','중단원 마무리하기',178,15),
(164,3,'문자와 식',8,'일차방정식의 활용','91','중단원 마무리하기',179,15),
(165,3,'문자와 식',8,'일차방정식의 활용','91','중단원 마무리하기',180,15),
(166,3,'문자와 식',8,'일차방정식의 활용','91','중단원 마무리하기',181,15),
(167,4,'좌표평면과 그래프',9,'순서쌍과 좌표','1','순서쌍과 좌표',184,15),
(168,4,'좌표평면과 그래프',9,'순서쌍과 좌표','1','순서쌍과 좌표',185,15),
(169,4,'좌표평면과 그래프',9,'순서쌍과 좌표','1','순서쌍과 좌표',186,15),
(170,4,'좌표평면과 그래프',9,'순서쌍과 좌표','2','사분면',187,15),
(171,4,'좌표평면과 그래프',9,'순서쌍과 좌표','2','사분면',188,15),
(172,4,'좌표평면과 그래프',9,'순서쌍과 좌표','2','사분면',189,15),
(173,4,'좌표평면과 그래프',9,'순서쌍과 좌표','90','배운대로 학습하기',190,15),
(174,4,'좌표평면과 그래프',9,'순서쌍과 좌표','90','배운대로 학습하기',191,15),
(175,4,'좌표평면과 그래프',9,'순서쌍과 좌표','3','그래프',192,15),
(176,4,'좌표평면과 그래프',9,'순서쌍과 좌표','3','그래프',193,15),
(177,4,'좌표평면과 그래프',9,'순서쌍과 좌표','3','그래프',194,15),
(178,4,'좌표평면과 그래프',9,'순서쌍과 좌표','3','그래프',195,15),
(179,4,'좌표평면과 그래프',9,'순서쌍과 좌표','90','배운대로 학습하기',196,15),
(180,4,'좌표평면과 그래프',9,'순서쌍과 좌표','90','배운대로 학습하기',197,15),
(181,4,'좌표평면과 그래프',9,'순서쌍과 좌표','93','서술형 훈련하기',198,15),
(182,4,'좌표평면과 그래프',9,'순서쌍과 좌표','93','서술형 훈련하기',199,15),
(183,4,'좌표평면과 그래프',9,'순서쌍과 좌표','91','중단원 마무리하기',200,15),
(184,4,'좌표평면과 그래프',9,'순서쌍과 좌표','91','중단원 마무리하기',201,15),
(185,4,'좌표평면과 그래프',9,'순서쌍과 좌표','91','중단원 마무리하기',202,15),
(186,4,'좌표평면과 그래프',10,'정비례와 반비례','1','정비례',204,15),
(187,4,'좌표평면과 그래프',10,'정비례와 반비례','1','정비례',205,15),
(188,4,'좌표평면과 그래프',10,'정비례와 반비례','2','정비례 관계 y=ax의 그래프',206,15),
(189,4,'좌표평면과 그래프',10,'정비례와 반비례','2','정비례 관계 y=ax의 그래프',207,15),
(190,4,'좌표평면과 그래프',10,'정비례와 반비례','2','정비례 관계 y=ax의 그래프',208,15),
(191,4,'좌표평면과 그래프',10,'정비례와 반비례','2','정비례 관계 y=ax의 그래프',209,15),
(192,4,'좌표평면과 그래프',10,'정비례와 반비례','90','배운대로 학습하기',210,15),
(193,4,'좌표평면과 그래프',10,'정비례와 반비례','3','반비례',211,15),
(194,4,'좌표평면과 그래프',10,'정비례와 반비례','3','반비례',212,15),
(195,4,'좌표평면과 그래프',10,'정비례와 반비례','4','반비례 관계 y=a/x의 그래프',213,15),
(196,4,'좌표평면과 그래프',10,'정비례와 반비례','4','반비례 관계 y=a/x의 그래프',214,15),
(197,4,'좌표평면과 그래프',10,'정비례와 반비례','4','반비례 관계 y=a/x의 그래프',215,15),
(198,4,'좌표평면과 그래프',10,'정비례와 반비례','4','반비례 관계 y=a/x의 그래프',216,15),
(199,4,'좌표평면과 그래프',10,'정비례와 반비례','4','반비례 관계 y=a/x의 그래프',217,15),
(200,4,'좌표평면과 그래프',10,'정비례와 반비례','90','배운대로 학습하기',218,15),
(201,4,'좌표평면과 그래프',10,'정비례와 반비례','90','배운대로 학습하기',219,15),
(202,4,'좌표평면과 그래프',10,'정비례와 반비례','93','서술형 훈련하기',220,15),
(203,4,'좌표평면과 그래프',10,'정비례와 반비례','93','서술형 훈련하기',221,15),
(204,4,'좌표평면과 그래프',10,'정비례와 반비례','91','중단원 마무리하기',222,15),
(205,4,'좌표평면과 그래프',10,'정비례와 반비례','91','중단원 마무리하기',223,15),
(206,4,'좌표평면과 그래프',10,'정비례와 반비례','91','중단원 마무리하기',224,15);
/*!40000 ALTER TABLE `bookstore_bookcontent` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
(11,'2026-01-12',9000,1,1,'2026-01-20',NULL,12,108),
...
(36,'2026-12-26',12000,1,1,'2026-01-20',NULL,19,108),
...
(48,'2026-01-19',15000,1,0,NULL,NULL,5,92),
(49,'2026-01-19',13000,1,0,NULL,NULL,21,109),
(50,'2026-01-20',12000,1,0,NULL,NULL,6,73);
...
--
-- Table structure for table `bookstore_studentbookprogress`
--

DROP TABLE IF EXISTS `bookstore_studentbookprogress`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `bookstore_studentbookprogress` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `study_date` date DEFAULT NULL,
  `achievement` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `needs_review` tinyint(1) NOT NULL,
  `homework_done` tinyint(1) NOT NULL,
  `created_at` datetime(6) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `bookstore_studentbookpro_book_sale_id_book_conten_d1f2a05e_uniq` (`book_sale_id`,`book_content_id`),
  KEY `bookstore_studentboo_book_content_id_f61d1a46_fk_bookstore` (`book_content_id`),
  KEY `bookstore_studentboo_teacher_id_6ab15890_fk_teachers_` (`teacher_id`),
  CONSTRAINT `bookstore_studentboo_book_content_id_f61d1a46_fk_bookstore` FOREIGN KEY (`book_content_id`) REFERENCES `bookstore_bookcontent` (`id`),
  CONSTRAINT `bookstore_studentboo_book_sale_id_60f7a5dc_fk_bookstore` FOREIGN KEY (`book_sale_id`) REFERENCES `bookstore_booksale` (`id`),
  CONSTRAINT `bookstore_studentboo_teacher_id_6ab15890_fk_teachers_` FOREIGN KEY (`teacher_id`) REFERENCES `teachers_teacher` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=207 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table
(1728,'2026-01-19',25,1,'20:00:00.000000','18:00:00.000000'),
(1729,'2026-01-19',28,1,'16:00:00.000000','14:00:00.000000'),
(1730,'2026-01-19',29,1,'20:00:00.000000','18:00:00.000000'),
(1731,'2026-01-19',30,1,'16:00:00.000000','14:00:00.000000'),
(1732,'2026-01-19',38,1,'20:00:00.000000','18:00:00.000000'),
(1733,'2026-01-19',39,1,'20:00:00.000000','18:00:00.000000'),
(1734,'2026-01-19',41,1,'20:00:00.000000','18:00:00.000000'),
(1735,'2026-01-19',45,1,'20:00:00.000000','18:00:00.000000'),
(1736,'2026-01-19',46,1,'20:00:00.000000','18:00:00.000000'),
(1737,'2026-01-20',12,1,'14:00:00.000000','12:00:00.000000'),
(1738,'2026-01-20',25,1,'14:00:00.000000','12:00:00.000000'),
(1739,'2026-01-20',28,1,'16:00:00.000000','14:00:00.000000'),
(1740,'2026-01-20',29,1,'14:00:00.000000','12:00:00.000000'),
(1741,'2026-01-20',30,1,'16:00:00.000000','14:00:00.000000'),
(1742,'2026-01-20',33,1,'14:00:00.000000','12:00:00.000000'),
(1743,'2026-01-20',39,1,'14:00:00.000000','12:00:00.000000'),
(1744,'2026-01-20',41,1,'14:00:00.000000','12:00:00.000000'),
(1745,'2026-01-20',45,1,'14:00:00.000000','12:00:00.000000'),
(1746,'2026-01-20',46,1,'14:00:00.000000','12:00:00.000000'),
(1747,'2026-01-21',10,1,'20:00:00.000000','18:00:00.000000'),
(1748,'2026-01-21',12,1,'20:00:00.000000','18:00:00.000000'),
(1749,'2026-01-21',25,1,'20:00:00.000000','18:00:00.000000'),
(1750,'2026-01-21',28,1,'16:00:00.000000','14:00:00.000000'),
(1751,'2026-01-21',29,1,'20:00:00.000000','18:00:00.000000'),
(1752,'2026-01-21',30,1,'16:00:00.000000','14:00:00.000000'),
(1753,'2026-01-21',39,1,'20:00:00.000000','18:00:00.000000'),
(1754,'2026-01-21',41,1,'20:00:00.000000','18:00:00.000000'),
(1755,'2026-01-21',45,1,'20:00:00.000000','18:00:00.000000'),
(1756,'2026-01-21',46,1,'20:00:00.000000','18:00:00.000000'),
(1757,'2026-01-22',12,1,'14:00:00.000000','12:00:00.000000'),
(1758,'2026-01-22',25,1,'14:00:00.000000','12:00:00.000000'),
(1759,'2026-01-22',28,1,'16:00:00.000000','14:00:00.000000'),
(1760,'2026-01-22',29,1,'14:00:00.000000','12:00:00.000000'),
(1761,'2026-01-22',30,1,'16:00:00.000000','14:00:00.000000'),
(1762,'2026-01-22',33,1,'14:00:00.000000','12:00:00.000000'),
(1763,'2026-01-22',41,1,'14:00:00.000000','12:00:00.000000'),
(1764,'2026-01-22',46,1,'14:00:00.000000','12:00:00.000000');
...
CREATE TABLE `teachers_message` (
  ...
  PRIMARY KEY (`id`),
  KEY `teachers_message_parent_id_80c54f9a_fk_teachers_message_id` (`parent_id`),
  KEY `teachers_message_recipient_id_df0043b4_fk_auth_user_id` (`recipient_id`),
  KEY `teachers_message_sender_id_fb5b0b4f_fk_auth_user_id` (`sender_id`),
  KEY `teachers_message_student_id_fa011acc_fk_students_student_id` (`student_id`),
  CONSTRAINT `teachers_message_parent_id_80c54f9a_fk_teachers_message_id` FOREIGN KEY (`parent_id`) REFERENCES `teachers_message` (`id`),
  CONSTRAINT `teachers_message_recipient_id_df0043b4_fk_auth_user_id` FOREIGN KEY (`recipient_id`) REFERENCES `auth_user` (`id`),
  CONSTRAINT `teachers_message_sender_id_fb5b0b4f_fk_auth_user_id` FOREIGN KEY (`sender_id`) REFERENCES `auth_user` (`id`),
  CONSTRAINT `teachers_message_student_id_fa011acc_fk_students_student_id` FOREIGN KEY (`student_id`) REFERENCES `students_student` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `teachers_message`
--

LOCK TABLES `teachers_message` WRITE;
/*!40000 ALTER TABLE `teachers_message` DISABLE KEYS */;
set autocommit=0;
INSERT INTO `teachers_message` VALUES
(1,'instruction','수업시간 중 스마트폰 사용 금지','가방 안에 모두 넣도록 해주세요.',1,'2026-01-22 01:16:09.029435','2026-01-22 01:20:57.822073',NULL,2,1,83),
(2,'instruction','수업 시간에 스마트폰은 모두 가방에 넣도록 해주세요.','특별한 경우만 허가해 주세요.',1,'2026-01-22 01:24:19.130810','2026-01-22 01:24:19.130848',NULL,NULL,1,NULL),
(3,'instruction','test notice','This is a notice sample.',0,'2026-01-22 01:35:49.615802','2026-01-22 01:35:49.615829',NULL,NULL,1,NULL),
(4,'reply','Re: 수업시간 중 스마트폰 사용 금지','그렇게 하겠습니다.',0,'2026-01-22 01:42:39.409777','2026-01-22 01:42:39.409805',1,1,2,83);
/*!40000 ALTER TABLE `teachers_message` ENABLE KEYS */;
UNLOCK TABLES;
commit;

--
-- Table structure for table `teachers_messagereadstatus`
--

DROP TABLE IF EXISTS `teachers_messagereadstatus`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `teachers_messagereadstatus` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `read_at` datetime(6) NOT NULL,
  `message_id` bigint NOT NULL,
  `user_id` int NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `teachers_messagereadstatus_message_id_user_id_50fe02c1_uniq` (`message_id`,`user_id`),
  KEY `teachers_messagereadstatus_user_id_e836ffb2_fk_auth_user_id` (`user_id`),
  CONSTRAINT `teachers_messageread_message_id_c881ac6b_fk_teachers_` FOREIGN KEY (`message_id`) REFERENCES `teachers_message` (`id`),
  CONSTRAINT `teachers_messagereadstatus_user_id_e836ffb2_fk_auth_user_id` FOREIGN KEY (`user_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `teachers_messagereadstatus`
--

LOCK TABLES `teachers_messagereadstatus` WRITE;
/*!40000 ALTER TABLE `teachers_messagereadstatus` DISABLE KEYS */;
set autocommit=0;
INSERT INTO `teachers_messagereadstatus` VALUES
(1,'2026-01-22 01:32:00.492993',2,2),
(2,'2026-01-22 01:36:21.130397',3,2);
/*!40000 ALTER TABLE `teachers_messagereadstatus` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...