...
urlpatterns = [
    ...
    path('stock-logs/settle/', views.stock_log_settle, name='stock_log_settle'),
    path('stock-logs/settle-cancel/', views.stock_log_settle_cancel, name='stock_log_settle_cancel'),
