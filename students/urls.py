...
urlpatterns = [
    ...
    path('<int:pk>/drive-upload/', views.student_drive_upload, name='student_drive_upload'),
    path('<int:pk>/drive-file/<str:file_id>/', views.student_drive_file_download, name='student_drive_file_download'),
