...
SUBJECT_GROUP_CHOICES = [
    ...
    ('02', '수학'),
    ('03', '영어'),
    ('04', '사회(역사/도덕 포함)'),   # 고등학교 2022 교육과정 공식 명칭
    ('05', '과학'),
    ('06', '기술가정/정보'),
    ('07', '체육'),
    ('08', '예술'),
    ('09', '제2외국어/한문'),           # 고등학교 2022 교육과정 공식 명칭
    ('10', '교양'),
...
# 중학교 전용 교과(군) 매핑 (도덕·한문 분리, 표현 달라짐)
_MS_GROUP_MAP = {
    '01': '국어',
    '02': '수학',
    '03': '영어',
    '04': '사회(역사 포함)',   # 중학교: 도덕 분리
    '05': '과학',
    '06': '기술가정/정보',
    '07': '체육',
    '08': '예술',
