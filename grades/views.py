...
def download_grade_template(request, template_type):
    ...
    if template_type == 'internal':
        ...
        headers = ['학년', '시험연도', '시험월', '시험명', '과목코드', '과목명', '원점수', '과목평균', '표준편차', '등급', '백분위']
        sample_data = [
            ['2', '2024', '3', '3월 학력평가', '1001', '국어', '85', '70.5', '12.3', '2', '88'],
            ['2', '2024', '3', '3월 학력평가', '2001', '수학', '92', '68.2', '15.1', '1', '95'],
            ['2', '2024', '6', '6월 모의평가', '1001', '국어', '82', '68.1', '11.8', '2', '85'],
        ]
